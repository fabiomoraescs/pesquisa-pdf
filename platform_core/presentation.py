...
LABELS = {
    ...
    "pdf_scraper": "Raspagem de PDFs", "document_analysis": "Análise documental",
    ...
    "user_soft_deleted": "Conta desativada", "tool_state_changed": "Estado da ferramenta alterado",
    ...
    "library_published": "Biblioteca publicada", "name": "Nome", "owner_user_id": "Proprietário",
